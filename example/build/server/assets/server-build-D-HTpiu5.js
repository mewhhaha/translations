import { r as requireReact, d as developmentExports } from "./app-CL_PAyzX.js";
...
async function handleRequest(request, responseStatusCode, responseHeaders, routerContext) {
  ...
  const body = await server_edgeExports.renderToReadableStream(
    /* @__PURE__ */ jsxRuntimeExports.jsx(developmentExports.ServerRouter, { context: routerContext, url: request.url }),
    {
      onError(error) {
...
function withComponentProps(Component) {
  return function Wrapped() {
    const props = {
      params: developmentExports.useParams(),
      loaderData: developmentExports.useLoaderData(),
      actionData: developmentExports.useActionData(),
      matches: developmentExports.useMatches()
    };
    return reactExports.createElement(Component, props);
  };
}
const s = Symbol();
const Context = reactExports.createContext(s);
const pull = async (source2, language) => {
  if (source2 === void 0) {
    return {};
  }
  const value = source2[`./${language}.json`];
...
const TranslationProvider = ({
  ...
  const [transition, startTransition] = reactExports.useTransition();
  const [locale, setInternalLocale] = reactExports.useState(
    Intl.getCanonicalLocales(defaultLocale)[0]
  );
  const language = getLanguage(locale);
  if (caches[namespace] === void 0) {
    caches[namespace] = {};
  }
  const cache = caches[namespace];
  if (cache[language] === void 0) {
    cache[language] = pull(source2, language);
  }
  const setLocale = reactExports.useCallback((locale2) => {
    startTransition(() => {
      console.debug(
        "Changing language to",
        Intl.getCanonicalLocales(locale2)[0]
      );
      setInternalLocale(Intl.getCanonicalLocales(locale2)[0]);
    });
  }, []);
  const translations = reactExports.use(cache[language]);
...
const source = /* @__PURE__ */ Object.assign({ "./en.json": () => import("./en--BrFBH6G.js"), "./jp.json": () => import("./jp-DZNB3b4b.js"), "./pl.json": () => import("./pl-mCaiI-VW.js"), "./sv.json": () => import("./sv-C0oMAVKg.js") });
function Layout({
  children
}) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", {
    ...
    children: [/* @__PURE__ */ jsxRuntimeExports.jsxs("head", {
      children: [/* @__PURE__ */ jsxRuntimeExports.jsx("meta", {
        ...
        children: "Speakeasy Example"
      }), /* @__PURE__ */ jsxRuntimeExports.jsx(developmentExports.Meta, {}), /* @__PURE__ */ jsxRuntimeExports.jsx(developmentExports.Links, {})]
    }), /* @__PURE__ */ jsxRuntimeExports.jsxs("body", {
      children: [children, /* @__PURE__ */ jsxRuntimeExports.jsx(developmentExports.ScrollRestoration, {}), /* @__PURE__ */ jsxRuntimeExports.jsx(developmentExports.Scripts, {})]
    })]
  });
}
const root = withComponentProps(function Root() {
  const [searchParams] = developmentExports.useSearchParams();
  const lng = searchParams.get("lng");
  return /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.Suspense, {
    children: /* @__PURE__ */ jsxRuntimeExports.jsx(TranslationProvider, {
      source,
      defaultLocale: lng ?? "en",
      children: /* @__PURE__ */ jsxRuntimeExports.jsx(developmentExports.Outlet, {})
    })
  });
});
...
const _$_ = withComponentProps(function Home() {
  const [formData, setFormData] = reactExports.useState(new FormData());
  const {
    t,
    setLocale,
    transition
  } = useTranslation();
  const [searchParams, setSearchParams] = developmentExports.useSearchParams();
  const lng = searchParams.get("lng");
    ...
    children: [/* @__PURE__ */ jsxRuntimeExports.jsx("header", {
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", {
        onSubmit: (e) => {
          ...
          const lng2 = formData2.get("language")?.toString();
          if (lng2) {
            setLocale(lng2);
            setSearchParams({
              lng: lng2
        ...
        children: [t("Select language"), /* @__PURE__ */ jsxRuntimeExports.jsxs("fieldset", {
          name: "language",
          ...
          "data-transition": transition || void 0,
      ...
      children: [/* @__PURE__ */ jsxRuntimeExports.jsxs("form", {
        ...
        children: [/* @__PURE__ */ jsxRuntimeExports.jsxs("div", {
          ...
          }), /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}), /* @__PURE__ */ jsxRuntimeExports.jsxs("label", {
            className: "grid grid-cols-subgrid col-span-2",
            children: [/* @__PURE__ */ jsxRuntimeExports.jsxs("span", {
              children: [t("Age"), " "]
            }), /* @__PURE__ */ jsxRuntimeExports.jsx("input", {
        ...
        children: [/* @__PURE__ */ jsxRuntimeExports.jsx("dt", {
          ...
          children: t("My name is {{name}}", {
            name: formData.get("name")?.toString() ?? "-"
          })
        }), /* @__PURE__ */ jsxRuntimeExports.jsx("dt", {
          children: t("Age")
        }), /* @__PURE__ */ jsxRuntimeExports.jsx("dd", {
          children: t("I am {{count}} years old", {
...
const serverManifest = { "entry": { "module": "/assets/entry.client-B96r1gmP.js", "imports": ["/assets/chunk-K6CSEXPM-DpS0MstQ.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/root-CxR9XVlB.js", "imports": ["/assets/chunk-K6CSEXPM-DpS0MstQ.js", "/assets/use-translation-DD160JX-.js"], "css": ["/assets/root-3kbdYB2K.css"], "clientActionModule": void 0, "clientLoaderModule": void 0, "hydrateFallbackModule": void 0 }, "routes/($)": { "id": "routes/($)", "parentId": "root", "path": ":?", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/(_)-OZ5gV9Uc.js", "imports": ["/assets/use-translation-DD160JX-.js", "/assets/chunk-K6CSEXPM-DpS0MstQ.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "hydrateFallbackModule": void 0 } }, "url": "/assets/manifest-1beb1e0e.js", "version": "1beb1e0e" };
const assetsBuildDirectory = "build\\client";
const basename = "/";
const future = { "unstable_middleware": false, "unstable_optimizeDeps": false, "unstable_splitRouteModules": false, "unstable_viteEnvironmentApi": true };
const ssr = true;
